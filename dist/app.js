...
/***/ function(module, exports) {
	...
	var _user$project$Bookmarks_Model$new = {
		id: '0',
		title: _elm_lang$core$Maybe$Just('Placeholder'),
		url: 'www.xxx',
		tags: ''
	};
	var _user$project$Bookmarks_Model$Bookmark = F4(
		function (a, b, c, d) {
			return {id: a, title: b, url: c, tags: d};
		});

	var _user$project$Bookmarks_Messages$FetchAllFailed = function (a) {
		return {ctor: 'FetchAllFailed', _0: a};
	};
	var _user$project$Bookmarks_Messages$FetchAllSucceded = function (a) {
		return {ctor: 'FetchAllSucceded', _0: a};
	};

	var _user$project$Bookmarks_Commands$url = 'http://localhost:8080/api/bookmarks';
	var _user$project$Bookmarks_Commands$memberDecoder = A5(
		_elm_lang$core$Json_Decode$object4,
		_user$project$Bookmarks_Model$Bookmark,
		...
		A2(_elm_lang$core$Json_Decode_ops[':='], 'tags', _elm_lang$core$Json_Decode$string));
	var _user$project$Bookmarks_Commands$listDecoder = _elm_lang$core$Json_Decode$list(_user$project$Bookmarks_Commands$memberDecoder);
	var _user$project$Bookmarks_Commands$fetchAll = A3(
		_elm_lang$core$Task$perform,
		_user$project$Bookmarks_Messages$FetchAllFailed,
		_user$project$Bookmarks_Messages$FetchAllSucceded,
		A2(_evancz$elm_http$Http$get, _user$project$Bookmarks_Commands$listDecoder, _user$project$Bookmarks_Commands$url));

	var _user$project$Helpers$getTitle = function (bookmark) {
		var _p0 = bookmark.title;
		if (_p0.ctor === 'Nothing') {
			return bookmark.url;
		} else {
			return _p0._0;
	...
	var _user$project$Bookmarks_List$bookmarkRow = function (bookmark) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_user$project$Helpers$getTitle(bookmark))
				]));
	};
	var _user$project$Bookmarks_List$list = function (bookmarks) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[]),
					A2(_elm_lang$core$List$map, _user$project$Bookmarks_List$bookmarkRow, bookmarks))
				]));
	};
	var _user$project$Bookmarks_List$view = function (bookmarks) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$Bookmarks_List$list(bookmarks)
				]));
	};

	var _user$project$Bookmarks_Update$update = F2(
		function (message, bookmarks) {
			var _p0 = message;
			if (_p0.ctor === 'FetchAllSucceded') {
				return {ctor: '_Tuple2', _0: _p0._0, _1: _elm_lang$core$Platform_Cmd$none};
			} else {
				var _p1 = A2(_elm_lang$core$Debug$log, 'FetchAllFailed', _p0._0);
				return {ctor: '_Tuple2', _0: bookmarks, _1: _elm_lang$core$Platform_Cmd$none};
			}
		});

	var _user$project$Messages$BookmarksMsg = function (a) {
		return {ctor: 'BookmarksMsg', _0: a};
	};
	...
	var _user$project$Routing$BookmarkRoute = function (a) {
		return {ctor: 'BookmarkRoute', _0: a};
	};
	var _user$project$Routing$BookmarksRoute = {ctor: 'BookmarksRoute'};
	var _user$project$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_evancz$url_parser$UrlParser$format,
				_user$project$Routing$BookmarksRoute,
				_evancz$url_parser$UrlParser$s('')),
				A2(
				_evancz$url_parser$UrlParser$format,
				_user$project$Routing$BookmarkRoute,
				A2(
	...
	var _user$project$Model$initialModel = function (route) {
		return {
			bookmarks: _elm_lang$core$Native_List.fromArray(
				[_user$project$Bookmarks_Model$new]),
			route: route
		};
	};
	var _user$project$Model$Model = F2(
		function (a, b) {
			return {bookmarks: a, route: b};
		});

	var _user$project$View$bookmarks = function (model) {
		return A2(
			_elm_lang$html$Html_App$map,
			_user$project$Messages$BookmarksMsg,
			_user$project$Bookmarks_List$view(model.bookmarks));
	};
	var _user$project$View$view = function (model) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$View$bookmarks(model)
				]));
	};
	...
	var _user$project$Update$update = F2(
		function (message, model) {
			var _p0 = message;
			var _p1 = A2(_user$project$Bookmarks_Update$update, _p0._0, model.bookmarks);
			var updatedBookmarks = _p1._0;
			var cmd = _p1._1;
			return {
				ctor: '_Tuple2',
				...
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Messages$BookmarksMsg, cmd)
			};
		});
	...
	var _user$project$Main$init = function (result) {
		...
		return {
			ctor: '_Tuple2',
			_0: _user$project$Model$initialModel(currentRoute),
			_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Messages$BookmarksMsg, _user$project$Bookmarks_Commands$fetchAll)
		};
	};
